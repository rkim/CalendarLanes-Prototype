...
$.fn.dragscrollable = function(options){
	...
	var dragscroll= {
		...
		mouseMoveHandler : function(event) { // User is dragging
			...
			var deltaX = (event.data.dragXAxis) ? event.clientX - event.data.lastCoord.left : 0;
			var deltaY = (event.data.dragYAxis) ? event.clientY - event.data.lastCoord.top : 0;
			var delta = {left: deltaX, top: deltaY};
	...
	this.each(function() {
		...
		var data = {scrollable : $(this),
			...
			dragXAxis : settings.dragXAxis,
			dragYAxis : settings.dragYAxis}
